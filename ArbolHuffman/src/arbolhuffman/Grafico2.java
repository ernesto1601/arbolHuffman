...
public class Grafico2 extends JPanel{
	...
	public Grafico2(LeeHuffman arbol){
          miArbol = arbol;
       ...
       public void paint(Graphics g){
           ...
           //  g.drawString("total de nodos: "+miArbol.cantidad(), 450, 10);
            // g.drawString("altura del arbol : "+ miArbol.retornarAltura(), 450, 20);
             ...
             graficarArbol(g2d, miArbol.raizA, Integer.MAX_VALUE, Integer.MAX_VALUE, fm.getLeading() + fm.getAscent());
